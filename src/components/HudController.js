export default class HudController {
    ...
    DisplayHud() {
        ...
        this.shipSpeed.innerHTML = 'Speed: ' + this.spaceShipControls.getSpeed().toFixed(5) + ' km/s'; 
        this.distanceToEarth.innerHTML = 'Distance to Earth: ' + (this.spaceShip.distanceToEarth / 1000).toFixed(4) + ' AU'; 
        this.distanceToMars.innerHTML = 'Distance to Mars: ' + (this.spaceShip.distanceToMars / 1000).toFixed(4) + ' AU'; 
